...
// bool find_less(struct list_elem *a, struct list_elem *b, void *aux)
// {
// 	// printf("\njoin : find_less\n");
...
// /* sleep list를 모두 순회하면서 wakeup_tick <= ticks 이면 unblcok하고 sleep_list에서 제거한다.*/
// void list_check_for_awake(struct list *list, int64_t ticks)
// {
// 	next_tick_to_awake = INT64_MAX;
// 	printf("\njoin : list_check_for_awake\n");
// 	struct list_elem *e= list_begin(list);
// 	struct thread *t;
// 	printf("\njoin : list_check_for_awake->\n");
// 	for (e ; e != list_end(list);)
// 		t = list_entry(e, struct thread, elem);
// 		if (t->wakeup_tick <= ticks)
// 		{
// 			printf("\nlist_remove\n");
